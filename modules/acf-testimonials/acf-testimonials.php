...
class ACFTestimonialsModule extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(array(
			'name'            => __( 'ACF Testimonials', 'fl-builder' ),
 ...
 */
FLBuilder::register_module('ACFTestimonialsModule', array(
	'fields' => array( // Tab
		'title'    => __( 'Fields', 'fl-builder' ), // Tab title
		'sections' => array( // Tab Sections
			'general' => array( // Section
				'title'  => 'ACF Fields', // Section Title
				'fields' => array( // Section Fields
					'testi_repeater_field' =>[
							'type' => "text",
							'label' => 'Acf Repeater field key',
					],
					'testi_person_name' => array(
						'type'         => 'text',
						'label'        => __( 'Sub field for person\'s name', 'fl-builder' ),
					),
					'testi_person_title'=>[
							'type' => 'text',
							'label' => 'Sub field for person\'s title',
					],
					'testi_quote' => [
							'type' => 'text',
							'label' => 'Sub field for quote text',
					],
					'testi_has_image' => [
						'type'    => 'select',
						'label'   => __( 'Show an image', 'fl-builder' ),
						'default' => '1',
						'options' => array(
							'0' => __( 'No', 'fl-builder' ),
							'1' => __( 'Yes', 'fl-builder' ),
